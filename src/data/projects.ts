...
export const selectedWorks: Project[] = [
  {
    caseNo: "01",
    title: "On-Call Agent",
    description: "智能值班与事件响应助手",
    role: "把故障排查 SOP 拆成检索、语义召回和 Agent 对话三段流程，让值班响应更可追踪。",
  ...
  },
  {
    caseNo: "02",
    title: "AI Sourcing",
    description: "AI 驱动的供应商发现与评估平台",
    role: "把线索搜索、网页抓取、信息抽取和团队推送连成一条自动化评估管线。",
  ...
  },
  {
    caseNo: "03",
    title: "Circuit Hero",
    description: "电路知识图谱与学习助手",
    role: "将电路知识图谱转译成剧情式网页游戏，用闯关反馈帮助青少年理解抽象概念。",
  ...
  },
  {
    ...
    description: "基于 RAG 的购物决策指南",
    role: "用 Android、FastAPI、Chroma 和大模型构建可演示的导购问答原型。",
...
export const aiProjects: Project[] = [
  ...selectedWorks.slice(0, 2),
  {
    ...
    description: "校园学习场景 AI 助手",
    role: "基于 300+ 问卷反馈收敛需求，迭代 prompt 架构、记忆机制和错题本功能。",
  ...
  selectedWorks[3],
  {
    ...
    description: "歌词驱动旋律预测实验",
    role: "基于九宫大成数据集探索旋律生成，把音乐信息处理纳入 AI/ML 项目集合。",
  ...
  },
  {
    ...
    description: "传统琵琶音乐自动转录系统评估",
    role: "围绕传统琵琶音乐评估自动转录系统，关注非西方音乐数据中的模型适配问题。",
...
export const mediaProjects: Project[] = [
  selectedWorks[2],
  {
    caseNo: "08",
    title: "Shapeville",
    description: "几何学习 Java Swing 交互应用",
    role: "用小型交互练习把几何知识拆成可操作任务，降低学习入口难度。",
  ...
  },
  {
    ...
    description: "网页端非遗黎锦小游戏",
    role: "把非遗黎锦文化内容转译成轻量网页互动，让文化信息可以被玩和探索。",
  ...
  },
  {
    ...
    description: "中国传统服饰信息可视化网站",
    role: "用网页视觉和信息组织方式呈现传统服饰资料，强调浏览路径和视觉层级。",
...
export const recognition = [
  ["Digital Art Therapy", "情绪计算与动态视听反馈研究"],
  ["Computer Design", "全国大学生计算机设计大赛二等奖"],
  ["Digital Media", "数媒科技作品及创意竞赛三等奖"],
  ["Math Modeling", "大湾区杯金融数学建模三等奖"],
] as const;
